...
const Utils = {
    ...
    friendlyError(error) {
        ...
        // Do NOT map 401/unauthorized generically — that masks real login errors.
        // The explicit "session expired" message is thrown by HttpClient only on
        // non-auth endpoints after a failed token refresh.
        return msg;
    },
};
